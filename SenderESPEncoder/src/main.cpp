...
uint8_t broadcastAddress2[] = {0x7C, 0x9E, 0xBD, 0x45, 0x36, 0xC0}; // Primeiro
uint8_t broadcastAddress1[] = {0xC8, 0xF0, 0x9E, 0xF2, 0x11, 0xB0}; // Segundo
uint8_t broadcastAddress3[] = {0x48, 0xE7, 0x29, 0x9A, 0x2D, 0xA0}; // Terceiro
//uint8_t broadcastAddress1[] = {0x48, 0xE7, 0x29, 0x97, 0x47, 0x54}; // Terceiro
